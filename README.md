...
## Содержание
1. Введение
2. Постановка задачи и обзор данных
3. Background
4. Zero-shot learning и Few-shot learning
5. Finetuning with QLoRA
6. Вывод
7. Список литературы
...
## Постановка задачи о обзор данных
...
## Zero-shot learning и Few-shot learning
...
Использование метода обучения — дообучения LLM модели — позволило достичь значительных улучшений в выявлении товарных атрибутов, используя ограниченные ресурсы.
